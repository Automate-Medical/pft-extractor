...
export const SPIROMETRY = [FVC, FEV1, FEV1_FVC, FEF25_75, FET]
...
export const PRE = /^(Best)?\s*Pre\s*$/
export const POST = /^(Best)?\s*Post\s*$/
export const REF = /^(Pred|Ref)\s*$/
export const PREREF = /^(%\s*?Pred|Pre%Ref)\s*?$/
export const POSTREF = /^(%PostPred|%\s*?Pred)\s*?$/
export const LLN = /^LLN\s*$/
export const ULN = /^ULN\s*$/
